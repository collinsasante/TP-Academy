    ...
    <>
      <section className={`footer ${style_2 ? "fstyle-2" : ""}`}>
              ...
              <div className="single-footer">
                <div className="about-footer">
                  <div className="footer-logo">
                    <a href="#">
                      <img src="assets/img/footer-logo.svg" alt="Edumon" />
                    </a>
                  </div>
                  <p>
                ...
                <div className="single-footer">
                  ...
                  <div className="contact-info">
                    ...
                    <p>
                      ...
                      <span>example@education.com</span>
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="copyright text-center wow fadeIn">
          <p>
            Copyright © {new Date().getFullYear()} <a href="#">Edumon</a>. All
            rights reserved.
          </p>
        </div>
      </section>
