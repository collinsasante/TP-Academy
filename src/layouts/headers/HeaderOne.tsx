...
export default function HeaderOne() {
  ...
  const [openMenu, setOpenMenu] = useState(false); // Fixed typo here
          ...
          <div className="row">
            ...
            <div className="col-30 right-col align-self-center text-end">
              <div className="searchcart">
                ...
                <div
                  id="sm_menu_ham"
                  className={`${openMenu ? "open" : ""}`} // Fixed typo here
                  onClick={() => setOpenMenu(!openMenu)} // Fixed typo here
                >
                  <span></span>
                  <span></span>
                  <span></span>
                ...
                <MobileMenu openMenu={openMenu} /> {/* Fixed typo here */}
              </div>
            </div>
          </div>
        </div>
